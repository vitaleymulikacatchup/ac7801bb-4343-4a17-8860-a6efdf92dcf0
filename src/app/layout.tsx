...
export const metadata: Metadata = {
  title: "Grand Palace Hotel - Luxury 5-Star Experience",
  description: "Experience unparalleled luxury at Grand Palace Hotel. Premium accommodations, world-class amenities, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, 5-star hotel, premium accommodations, hotel suites, fine dining, spa wellness, concierge service",
  metadataBase: new URL("https://grandpalacehotel.com"),
  alternates: {
    canonical: "https://grandpalacehotel.com"
  },
  openGraph: {
    title: "Grand Palace Hotel - Luxury 5-Star Experience",
    description: "Experience unparalleled luxury at Grand Palace Hotel with premium accommodations and world-class amenities.",
  ...
  twitter: {
    ...
    title: "Grand Palace Hotel - Luxury 5-Star Experience",
    description: "Experience unparalleled luxury at Grand Palace Hotel with premium accommodations and world-class amenities.",
    images: ["https://images.pexels.com/photos/7168582/pexels-photo-7168582.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
